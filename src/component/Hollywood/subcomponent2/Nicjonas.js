...
function Nicjonas(props) {
  ...
  return (
    ...
    {props.value.filter((item)=>item.categorey==="The Latest Article" && item.name==="Hollywood" && item.path==='/nicjonas').map((data,index)=>{
      return(
